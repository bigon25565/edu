 ...
 * @property TestHasAnswerFileUpload[] $testHasAnswerFileUploads0
...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(TestHasAnswerFileUpload::className(), ['student_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTestHasAnswerFileUploads0()
    {
        return $this->hasMany(TestHasAnswerFileUpload::className(), ['teacher_id' => 'id']);
    }
